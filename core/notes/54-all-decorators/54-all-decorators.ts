...
const pessoa = new UmaPessoa('Zé', 'Alicate', 731);
pessoa.nomeCompleto = 'Zé Alicate De Oliveira';
const metodo = pessoa.metodo('Fala Zé!');
const metodoEstatico = UmaPessoa.metodoEstatico('Pipoca quente na manteiga.');
console.log(pessoa);
console.log(metodo);
